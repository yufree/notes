...
I suggest any group member to build their data analysis project in RStudio(Click File - New project - New dictionary - Empty project). Then assign a name for your project. I recommend the following tips if you are familiar with it.
